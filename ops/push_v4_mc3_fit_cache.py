#!/usr/bin/env python
"""Push one private, commit-pinned V4 TRAIN-label collection shard."""
...
TEMPLATE = REPO / "kaggle/v4_mc3_fit_cache_cell.sh"
...
def payload(commit: str, account: str, codec: str, shard: int,
    ...
    slug = f"dual-v4-mc3-fit-{codec}-s{shard}"
    ...
    book["cells"][0]["id"] = f"dual-v4-mc3-fit-{codec}-s{shard}"
