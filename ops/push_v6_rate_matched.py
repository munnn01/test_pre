#!/usr/bin/env python
"""Push a commit-pinned V6 resolution/QP TRAIN feasibility shard to Kaggle."""
...
TEMPLATE = REPO / "kaggle/v6_rate_matched_cell.sh"
...
def payload(commit: str, account: str, codec: str, shard: int,
    ...
    slug = f"dual-v6-rateqp-{codec}-s{shard}"
